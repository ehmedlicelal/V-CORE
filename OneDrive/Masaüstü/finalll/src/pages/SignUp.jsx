...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-secondary/20 blur-[100px] -z-10 rounded-full opacity-30"></div>
      ...
      <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Join megumi and start your cybersecurity journey</p>
        </div>
